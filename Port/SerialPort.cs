...
namespace SerialPortLib2.Port
{
	...
	public class SerialPort : Component
	{
        ...
        //jj
        bool is_virtual_port;

		public SerialPort () : 
			this (GetDefaultPortName (), DefaultBaudRate, DefaultParity, DefaultDataBits, DefaultStopBits, false)
		{
		}
		...
		public SerialPort (string portName) :
			this (portName, DefaultBaudRate, DefaultParity, DefaultDataBits, DefaultStopBits, false)
		{
		}

		public SerialPort (string portName, int baudRate) :
			this (portName, baudRate, DefaultParity, DefaultDataBits, DefaultStopBits, false)
		{
		}

		public SerialPort (string portName, int baudRate, Parity parity) :
			this (portName, baudRate, parity, DefaultDataBits, DefaultStopBits, false)
		{
		}

		public SerialPort (string portName, int baudRate, Parity parity, int dataBits) :
			this (portName, baudRate, parity, dataBits, DefaultStopBits, false)
		{
		}
        ...
        //ADDED for virtualport
        [Browsable(true)]
        [MonitoringDescription("")]
        public bool IsVirtualPort
        {
            get
            {
                return is_virtual_port;
            }
            set
            {
                is_virtual_port = value;
            }
        }
		...
		public void Open ()
		{
            ...
            if (IsWindows) // Use windows kernel32 backend
				...
				stream = new SerialPortStream (port_name, baud_rate, data_bits, parity, stop_bits, dtr_enable,
					rts_enable, handshake, read_timeout, write_timeout, readBufferSize, writeBufferSize, is_virtual_port);
